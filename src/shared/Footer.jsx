...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center p-10 bg-[#070d15] text-[#ddd] rounded">
            <div className="grid grid-flow-col gap-4">
                <Link to='' className="link link-hover">About us</Link>
                <Link to='' className="link link-hover">Donation</Link>
                <Link to='' className="link link-hover">Contact</Link>
                <Link to='' className="link link-hover">Our Events</Link>
            ...
            <div>
                <p>Copyright © {year} - All Right Reserved by Host of the Peace Environment Inc.</p>
            </div>
        </footer>
    );
};
